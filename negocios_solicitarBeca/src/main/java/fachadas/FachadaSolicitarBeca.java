 ...
 */
public class FachadaSolicitarBeca  {
    private final ControlSolicitarBeca controlSolicitarBeca;
...
//    }
    ...
    public FachadaSolicitarBeca(ControlSolicitarBeca control) {
        this.controlSolicitarBeca = Objects.requireNonNull(control);
    }
    ...
    public void agregarEstudiante(EstudianteDTO estudiante) throws SolicitudInvalidaException {
        assertSolicitudIniciada();
        control.asignarEstudiante(solicitudActual, estudiante);
    }

    /* Paso 2: agregar/seleccionar beca */
    public void agregarBeca(BecaDTO beca) throws SolicitudInvalidaException {
        assertSolicitudIniciada();
        control.asignarBeca(solicitudActual, beca);
    }

    /* Paso 3: agregar documentos (lista completa) */
    public void agregarDocumentos(List<DocumentoDTO> documentos) throws SolicitudInvalidaException {
        assertSolicitudIniciada();
        control.asignarDocumentos(solicitudActual, documentos);
    }

    /* Paso 4: agregar historial */
    public void agregarHistorial(HistorialAcademicoDTO historial) throws SolicitudInvalidaException {
        assertSolicitudIniciada();
        control.asignarHistorial(solicitudActual, historial);
    }

    /* Paso 5: agregar informacion socioeconomica */
    public void agregarInfoSocioeconomica(InformacionSocioeconomicaDTO info) throws SolicitudInvalidaException {
        assertSolicitudIniciada();
     ...
     */
    public SolicitudDTO validarYEnviarSolicitud() throws SolicitudInvalidaException {
        assertSolicitudIniciada();
        ...
        SolicitudDTO finalizada = this.solicitudActual;
