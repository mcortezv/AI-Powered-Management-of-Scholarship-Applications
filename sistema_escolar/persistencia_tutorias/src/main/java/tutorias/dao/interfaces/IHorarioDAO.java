...
public interface IHorarioDAO {
    ...
    List<HorarioDocument> obtenerDisponiblesPorTutorYFecha(Long idTutor, LocalDate fecha)
            throws HorarioDAOException;

    HorarioDocument actualizarEstado(ObjectId idHorario, EstadoDisponibilidad nuevoEstado)
            throws HorarioDAOException;
}
