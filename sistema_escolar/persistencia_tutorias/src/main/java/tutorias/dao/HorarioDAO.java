...
public class HorarioDAO implements IHorarioDAO{
    ...
    @Override
    public List<HorarioDocument> obtenerDisponiblesPorTutorYFecha(Long idTutor, LocalDate fecha)
            throws HorarioDAOException {
        try {
            return col.find(
                    and(
                            eq("idTutor", idTutor),
    ...
    @Override
    public HorarioDocument actualizarEstado(ObjectId idHorario, EstadoDisponibilidad nuevoEstado)
            throws HorarioDAOException {
        try {
