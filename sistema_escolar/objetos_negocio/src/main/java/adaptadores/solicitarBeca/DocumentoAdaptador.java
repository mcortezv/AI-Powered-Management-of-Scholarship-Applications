...
public class DocumentoAdaptador {
    ...
    public static Documento toEntity(DocumentoDTO dto) {
        try {
            ...
            throw new DocumentoAdaptadorException("Error al convertir DTO Documento a entidad");
        }
    }
    ...
    public static DocumentoDocument toDocument(Documento document, ObjectId estudianteId) {
        try {
            ...
            throw new BecasFiltradasAdaptadorException("Error al convertir entidad Documento a Document");
        }
    }
}
