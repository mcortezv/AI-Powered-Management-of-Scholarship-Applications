 ...
 */
public class RequisitosResponseDTO {
    ...
    public RequisitosResponseDTO() {
    }

    public RequisitosResponseDTO(double promedioMinimo, double ingresoFamiliarMaximo, double procentajeBajas, double cargaAcademica, double indiceReprobacion, boolean trabajo, boolean deudas) {
