 ...
 */
public class RequisitosInfraestructuraDTO {
    ...
    public RequisitosInfraestructuraDTO() {
    }

    public RequisitosInfraestructuraDTO(double promedioMinimo, double ingresoFamiliarMaximo, double procentajeBajas, double cargaAcademica, double indiceReprobacion, boolean trabajo, boolean deudas) {
