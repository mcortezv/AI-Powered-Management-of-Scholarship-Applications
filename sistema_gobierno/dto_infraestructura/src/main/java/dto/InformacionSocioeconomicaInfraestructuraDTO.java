 ...
 */
public class InformacionSocioeconomicaInfraestructuraDTO {
    private  BigDecimal ingresoTotalFamilarMensual;
    private String tipoVivienda;
    private boolean trabajo;
    private boolean deudas;

    public InformacionSocioeconomicaInfraestructuraDTO() {}

    public InformacionSocioeconomicaInfraestructuraDTO(BigDecimal ingresoTotalFamilarMensual, String tipoVivienda, boolean trabajo, boolean deudas) {
