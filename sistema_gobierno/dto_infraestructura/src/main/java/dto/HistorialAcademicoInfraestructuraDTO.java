 ...
 */
public class HistorialAcademicoInfraestructuraDTO {
    ...
    public HistorialAcademicoInfraestructuraDTO() {}

    public HistorialAcademicoInfraestructuraDTO(double cargaAcademica, String carrera, double indiceReprobacion, double procentajeBajas, double promedio, int semestre) {
