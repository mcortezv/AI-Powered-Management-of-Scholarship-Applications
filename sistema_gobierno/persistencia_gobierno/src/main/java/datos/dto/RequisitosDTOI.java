...
public class RequisitosDTOI {
    ...
    public RequisitosDTOI() {
    }
    
    public RequisitosDTOI(double promedioMinimo, double ingresoFamiliarMaximo, double procentajeBajas, double cargaAcademica, double indiceReprobacion, boolean trabajo, boolean deudas) {
