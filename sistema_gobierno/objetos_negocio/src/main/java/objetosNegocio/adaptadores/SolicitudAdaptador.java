...
public class SolicitudAdaptador {
    ...
    public static Solicitud toEntity(SolicitudInfraestructuraDTO dto){
        try {
            ...
            solicitud.setHistorialAcademico(HistorialAcademicoAdaptador.toEntity(dto.getHistorialAcademico()));
            List<Documento> documentos = new ArrayList<>();
            for (DocumentoInfraestructuraDTO documentoDTO : dto.getDocumentos()){
                documentos.add(DocumentoAdaptador.toEntity(documentoDTO));
            }
            solicitud.setDocumentos(documentos);
            solicitud.setFecha(dto.getFecha());
    ...
    public static SolicitudInfraestructuraDTO toInfraestructuraDTO(Solicitud  solicitud){
        try {
            SolicitudInfraestructuraDTO dto = new SolicitudInfraestructuraDTO();
            dto.setId(solicitud.getId());
            ...
            List<DocumentoInfraestructuraDTO> documentoInfraestructuraDTO = new ArrayList<>();
            for (Documento documento : solicitud.getDocumentos()){
