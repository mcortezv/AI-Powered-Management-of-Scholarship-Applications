...
//    }
    ...
    public SolicitudBecasDisponiblesResponseDTO obtenerBecas(){
        ...
        BecaDTO beca1 = new BecaDTO(1, "Apoyo Economico", "Moisés Vázquez Gudiño", "Dirigida a estudiantes con escasos recursos económicos, Dirigida a estudiantes con escasos recursos económicos, Dirigida a estudiantes con escasos recursos económicos, Dirigida a estudiantes con escasos recursos económicos, "
                + "Dirigida a estudiantes con escasos recursos económicos, Dirigida a estudiantes con escasos recursos económicos, Dirigida a estudiantes con escasos recursos económicos ", "2025-2", 50, new RequisitosDTO(7.0, 12000.0, 30.0, 50.0, 30.0, false, true), ahora.plusMonths(1));               
